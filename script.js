...
subTitle.textContent =
	"Soy formado de manera autodidacta estudiando por mi cuenta y actualmente estoy participando en el proyecto Oracle ONE en el Grupo G7 en Alura Latam Front-end.";
...
<div class="academic__courses">
    ...
    <div class="academic__courses__box">
        <ul class="academic__courses__list">
            ...
            <li class="academic__courses__item__title"><h4>Formación Front End G7 - ONE</h4></li>
            <li class="academic__courses__item__subtitle"><p>Alura - 2024</p></li>
        </ul>
    </div>
    <div class="academic__courses__box">
        <ul class="academic__courses__list">
